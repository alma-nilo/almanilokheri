...
const DashManualAdded = () => {
  ...
  const fetch = useCallback(async () => {
    ...
    let url = `${process.env.REACT_APP_API_KEY}/admins/manual-added`;
    try {
  ...
  return (
    <Box m="0px 10px 10px 10px">
      <Header
        title="All User Added By College"
        subtitle="Managing All students Added by college"
      />
      <Box
        m="0px 5px 0 0"
        height="80vh"
...
export default DashManualAdded;
