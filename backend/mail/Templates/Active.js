export const Active = (name) => {
  return `<!DOCTYPE html>
      <html>
        <head>
          <meta charset="UTF-8" />
          <title>Alumni Account Active</title>
          <style>
            body {
        ...
        <body>
          <div class="container">
            ...
            <p>
              Dear ${name} your Account for alumni membership to GBN Govt
              Polytechnic Nilokheri has been Active again. We are delighted to welcome you
